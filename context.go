...
// accelerators can draw: a single colour.
//
// They paint every draw in one colour, read from the brush at (0, 0), so a
// gradient or a pattern would come out as a flat fill of its first colour.
